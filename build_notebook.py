  ...
  "cells": [
    ...
    },
    {
      ...
      "source": [
        ...
        "model_input['input_tokens'] = jnp.ones((1, 1024), dtype=jnp.int32)\n",
        "model_input['positions'] = jnp.arange(1024, dtype=jnp.int32)[None, :]\n",
        "model_input['attention_mask'] = jnp.ones((1, 1024), dtype=jnp.int32)\n",
